  ...
  return (
    <div className='edit-modal-background'>
      <div className='edit-modal'>
            ...
            <select  className='edit-modal-category'
            ...
            <input type="text" className='edit-modal-title' placeholder='Enter New Title'
            value={editModalTitle}
            onChange={e => setEditModalTitle(e.target.value)} />
            <p className='edit-modal-description-p'>New Description:</p>
            <input type="text" className='edit-modal-description' placeholder='Enter New Description'
            value={editModalDescription}
            onChange={e => setEditModalDescription(e.target.value)}/>
            <button onClick={closeEditModal} className='edit-modal-close'>Close</button>
            <button className='edit-modal-submit' onClick={handleEditSubmit}>Submit</button>
      </div>
    </div>
  )
}
